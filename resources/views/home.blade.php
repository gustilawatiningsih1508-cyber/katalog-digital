            ...
            <div class="container ">
                <div class="row">
                    <div class="col-md-6  ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="{{ asset('assets/images/milo1.jpg') }}" alt="10">
                            </div>
                    ...
                    <div class="col-md-6  ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="{{ asset('assets/images/ngemil2.jpg') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Ngemil Yuk
                        ...
                        <div class="box">
                            <div>
                                ...
                                <div class="detail-box">
                                    ...
                                    <p>
                                        Diambil Langsung dari Malaysia
                                    </p>
                                    <div class="options">
                                        <g>
                                        </g>
        ...
        <div class="row grid">
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{ asset('assets user/images/f2.png') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Burger
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{ asset('assets user/images/f3.png') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{ asset('assets user/images/f4.png') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pasta
          ...
          <div class="col-sm-6 col-lg-4 all fries">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{ asset('assets user/images/f5.png') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    French Fries
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{ asset('assets user/images/f6.png') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{ asset('assets user/images/f7.png') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Tasty Burger
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{ asset('assets user/images/f8.png') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Tasty Burger
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{ asset('assets user/images/f9.png') }}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pasta
  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="{{ asset('assets user/images/about-img.png') }}" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
